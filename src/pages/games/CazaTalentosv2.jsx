...
const CazaTalentos = () => {
  ...
  return (
    <div className="relative w-full max-w-md mx-auto h-[600px] bg-neutral-50 dark:bg-neutral-950 rounded-[3rem] overflow-hidden border-4 border-white dark:border-neutral-900 shadow-2xl flex flex-col pt-3">
