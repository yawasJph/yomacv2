...
export const InputMessage = memo(({ input, setInput, onSubmit, sendTypingSignal }) => {
      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          ...
          <div className="flex items-center justify-between px-3 py-2 mt-1 border-t border-neutral-800/50">
            <span
              className={`text-[10px] font-bold tracking-tight px-2 ${input.length >= MAX_CHARS ? "text-red-500" : "text-neutral-500"}`}
            >
