...
import { MessageSquarePlus, ChevronLeft, Send, MoreVertical, Search } from "lucide-react";
...
const MessagesPage = () => {
    ...
    if (activeChat) {
      ...
      const channel = supabaseClient
        ...
        .on('postgres_changes', { 
          ...
          if (payload.new.sender_id === activeChat.friend_id) {
  ...
  const loadMutuals = async () => {
    const { data, error } = await supabaseClient.rpc("get_mutual_followers", {
      user_id: user.id,
    });
