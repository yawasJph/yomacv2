...
const CreateBlog2 = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto min-h-screen bg-white dark:bg-zinc-950 p-6">
      ...
      <div className="flex flex-col gap-6 mb-8">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            disabled={loading}
            className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-zinc-700 text-white px-8 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-indigo-500/20"
          >
      ...
      {/* Preview del Banner */}
      {/* {previewUrl && (
        <div className="mb-5 rounded-3xl overflow-hidden h-[350px] w-full border border-zinc-200 dark:border-zinc-800 shadow-xl">
          <img
            src={previewUrl}
            alt="Preview"
      ...
      <div className="relative mb-10 rounded-3xl overflow-hidden h-[350px] border dark:border-zinc-800 shadow-xl">
        <img src={previewUrl} className={`w-full h-full object-cover transition-opacity ${loading ? 'opacity-40' : 'opacity-100'}`} />
        {loading && (
