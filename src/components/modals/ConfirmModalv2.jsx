      ...
      <div className="relative w-[92%] max-w-md rounded-2xl bg-white dark:bg-zinc-900 shadow-2xl animate-in zoom-in-95 fade-in duration-200 border border-gray-200 dark:border-zinc-700">
        ...
        <div className="flex justify-end gap-3 px-6 pb-6">
          ...
          <button
            onClick={onClose}
            disabled={isLoading}
            className="px-4 py-2 rounded-lg text-sm font-medium bg-gray-100 hover:bg-gray-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 transition text-gray-600 dark:text-gray-300"
          >
            Cancelar
          </button>
