...
const Header = () => {
  ...
  //const onViewCredits = searchParams.get("onViewCredits") === "true";
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 h-16 bg-white/60 dark:bg-black/80 backdrop-blur-lg border-b border-emerald-500/10 dark:border-emerald-500/20 z-50`}
    >
