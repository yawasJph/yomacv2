...
const HudSection = ({seconds, moves }) => {
  return (
    <div className="grid grid-cols-3 gap-4 mb-3 sm:mb-8">
        <div className="bg-linear-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 p-3 rounded-2xl border-2 border-blue-100 dark:border-blue-800/30 
