...
const CustomVideoPlayer = ({ src, autoPlay = true }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/90 via-black/60 to-transparent p-3 sm:p-4 rounded-b-xl transition-all duration-300 ${
