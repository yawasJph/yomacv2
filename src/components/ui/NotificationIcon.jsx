...
const NotificationIcon = () => {
  ...
  return (
    <>
      <div
        className="relative p-2   rounded-full transition-colors dark:text-indigo-400"
      >
        <button
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute top-0 right-0 bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-white dark:border-neutral-900">
